...
public class Course {
	...
	private Category categories;  // done
	
	@OneToMany(mappedBy = "courses", fetch = FetchType.LAZY)
	private List<Video> videos; // done
	
	@OneToMany(mappedBy = "courses",fetch = FetchType.LAZY)
	private List<Target> targets; // done
	...
	public Course(int id, String title, String image, int lectures_count, int hour_count, Date last_update,
